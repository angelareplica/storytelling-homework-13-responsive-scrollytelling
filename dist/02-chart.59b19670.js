...
module.exports = "/housing-prices.6809c434.csv";
...
var margin = { top: 100, left: 50, right: 170, bottom: 30 };
...
function ready(datapoints) {
  ...
  svg.selectAll('path').data(nested).enter().append('path').attr('class', 'lines').classed('united-states', function (d) {
    // console.log(d.key)
    return d.key === 'U.S.';
  ...
  }).classed('pacific', function (d) {
    return d.key === 'Pacific';
  }).classed('west-south-central', function (d) {
    return d.key === 'West South Central';
  }).classed('south-atlantic', function (d) {
  ...
  svg.selectAll('circle').data(nested).enter().append('circle').attr('class', 'circles').classed('united-states', function (d) {
    return d.key === 'U.S.';
  }).classed('mountain', function (d) {
    return d.key === 'Mountain';
  }).classed('pacific', function (d) {
  ...
  svg.selectAll('text').data(nested).enter().append('text').attr('class', 'label-text').classed('united-states', function (d) {
    return d.key === 'U.S.';
  }).classed('mountain', function (d) {
    return d.key === 'Mountain';
  }).classed('pacific', function (d) {
  ...
  svg.append('rect').attr('class', 'dec-rect').attr('x', xPositionScale(parseTime('December-16'))).attr('y', 0).attr('width', rectWidth).attr('height', height).attr('fill', '#C2DFFF').lower();
  ...
  // Adding the steps
  d3.select('#requirements-2').on('stepin', function () {
    svg.selectAll('.lines').attr('stroke', 'none').attr('fill', 'none');
  ...
  d3.select('#lines').on('stepin', function () {
    svg.selectAll('.lines').data(nested).attr('stroke', function (d) {
      return colorScale(d.key);
    }).attr('stroke-width', 2).attr('fill', 'none');

    svg.selectAll('.circles').data(nested).attr('fill', function (d) {
      return colorScale(d.key);
    });

    svg.selectAll('.label-text').attr('opacity', 1).attr('fill', 'black');
  });
  ...
  d3.select('#winter').on('stepin', function () {
    svg.selectAll('.dec-rect').attr('fill', '#C2DFFF').lower();
  });
  ...
  function render() {
    ...
    svg.selectAll('.label-text').data(nested).attr('y', function (d) {
      return yPositionScale(d.values[0].price);
    }).attr('x', function (d) {
      return xPositionScale(d.values[0].datetime);
    });

    svg.selectAll('.circles').data(nested).attr('cy', function (d) {
      return yPositionScale(d.values[0].price);
    }).attr('cx', function (d) {
      return xPositionScale(d.values[0].datetime);
    });
    ...
    var rectWidth = xPositionScale(parseTime('February-17')) - xPositionScale(parseTime('November-16'));
    svg.selectAll('.dec-rect').attr('x', xPositionScale(parseTime('December-16'))).attr('width', rectWidth).attr('height', newHeight);
...
},{"d3":"../node_modules/d3/index.js","./data/housing-prices.csv":"data/housing-prices.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/02-chart.59b19670.map