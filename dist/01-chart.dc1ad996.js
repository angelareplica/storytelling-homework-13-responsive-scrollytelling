...
module.exports = "/countries.6cf99926.csv";
...
function ready(datapoints) {
  ...
  d3.select('#na').on('stepin', function () {
    svg.selectAll('rect').attr('fill', 'lightgrey');
    svg.selectAll('.namerica').attr('fill', '#4cc1fc');
  });

  d3.select('#low-gdp').on('stepin', function () {
  ...
  d3.select('#continents-colored').on('stepin', function () {
    svg.selectAll('rect').attr('fill', function (d) {
      return colorScale(d.continent);
    });
  });

  d3.select('#reset').on('stepin', function () {
    svg.selectAll('rect').attr('fill', 'lightgrey');
  });
  ...
  function render() {
    ...
    var screenHeight = height / width * screenWidth;
    ...
    svg.select('.gdp-note-high').attr('text-anchor', 'middle').attr('font-size', 12).attr('x', newWidth * 0.75).attr('y', newHeight + 15);

    svg.select('.gdp-note-low').attr('text-anchor', 'middle').attr('font-size', 12).attr('x', newWidth * 0.25).attr('y', newHeight + 15);
...
},{"d3":"../node_modules/d3/index.js","./data/countries.csv":"data/countries.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/01-chart.dc1ad996.map