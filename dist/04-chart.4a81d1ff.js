...
module.exports = "/ces.33808cf7.csv";
},{}],"data/wages.csv":[function(require,module,exports) {
module.exports = "/wages.f5c0fb8e.csv";
...
var margin = { top: 20, left: 25, right: 0, bottom: 70 };
...
function ready(_ref) {
  ...
  svg.selectAll('.ces').data(ces).enter().append('g').attr('class', 'ces').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).each(function (d) {
    var svg = d3.select(this);

    var dataColumns = Object.keys(d).filter(function (d) {
      return d[0] === '2';
    });
    // console.log('datacolumns looks like', dataColumns)

    var datapoints = dataColumns.map(function (colName) {
      return {
        name: colName,
        jobs: +d[colName]
      };
    ...
    svg.selectAll('path').data(datapoints).enter().append('path');
  });
}
},{"d3":"../node_modules/d3/index.js","./data/ces.csv":"data/ces.csv","./data/wages.csv":"data/wages.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/04-chart.4a81d1ff.map